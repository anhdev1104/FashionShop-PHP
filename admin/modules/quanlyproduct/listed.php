                ...
                ?>
                    <tr class="text-center">
                        ...
                        <td style="width: 200px;">
                            <img src="modules/quanlyproduct/uploads/<?= $images; ?>" alt="" class="img-fluid">
                        </td>
                        <td style="width: 200px;">
                            <img src="modules/quanlyproduct/uploads/<?= $images_hover; ?>" alt="" class="img-fluid" style="object-fit: cover;">
                        </td>
                        <td><?= number_format($price).'đ'; ?></td>
                        <td><?= number_format($old_price).'đ'; ?></td>
                        <td><?= $quantity; ?></td>
                        <td><?= $category_name; ?></td>
                        <td><?= $descript; ?></td>
                        <td>
